...
uses
  ...
  ComCtrls, Menus, ActnList, StdActns, ExtCtrls, SynFacilUtils, SynFacilHighlighter,
  XpresParser, Process, Globales, FormConfig, FormOut;
...
begin
  e := TSynFacilEditor.Create(edXpr, 'SinNombre','ttm');
  edXpr.Align:=alLeft;
